...
if [ ! -f eclipse-jee-2021-03-R-linux-gtk-x86_64.tar.gz ]; then
	echo
	echo "*** Download Eclipse ***"
	echo
    wget https://download.eclipse.org/technology/epp/downloads/release/2021-03/R/eclipse-jee-2021-03-R-linux-gtk-x86_64.tar.gz
fi
if [ ! -d $ECLIPSE ]; then
	echo
	echo "*** Extract Eclipse ***"
	echo
	tar -xvf eclipse-jee-2021-03-R-linux-gtk-x86_64.tar.gz
	ECLIPSE=eclipse
fi
